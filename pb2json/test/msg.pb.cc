...
void protobuf_AssignDesc_msg_2eproto() {
  ...
  static const int Body_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Body, sid_),
  ...
  static const int Request_offsets_[6] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Request, bodys_),
  };
  Request_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Request_descriptor_,
...
#ifndef _MSC_VER
const int Body::kSidFieldNumber;
...
const int Request::kBodysFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(42)) goto parse_args;
        if (input->ExpectTag(50)) goto parse_bodys;
        break;
      }
...
bool Request::IsInitialized() const {
  ...
  for (int i = 0; i < bodys_size(); i++) {
    if (!this->bodys(i).IsInitialized()) return false;
  }
  return true;
}
